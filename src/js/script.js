...
for (let i = 0; i < dropList.length; i++) {
    ...
    dropList[i].addEventListener("change", e =>{
        loadFlag(e.target); // calling lo   adFlag with passing target element as an argument
    });
}
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/809c2d6931a9be122f4d8459/latest/${fromCurrency.value}`;
